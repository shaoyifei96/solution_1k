...
_CONFIGS = [
    ...
    # ================================================================
    # Second round: Scheduled Sampling experiments (from exp3 checkpoint)
    # ================================================================
    # SS only: zero-out predicates with linear decay 100%→50% GT
    TrainConfig(
        name="pi_behavior_b1k_exp3_ss",
        ...
        model=pi_behavior_config.PiBehaviorConfig(
            ...
            ss_gt_ratio_start=1.0,
            ss_gt_ratio_end=0.5,
            ss_warmup_steps=500,
            ss_decay_steps=15000,
            ss_mode="zero",
        ),
        data=LeRobotB1KDataConfig(
            repo_id="IliaLarchenko/behavior_224_rgb",
        ...
        num_flow_samples=15,
        weight_loader=weight_loaders.PiBehaviorWeightLoader(
            "/vast/projects/kumar/lab/yishao/checkpoints_50/pi_behavior_b1k_exp3/exp3_v2_deep_sets/6000/params",
            predicate_encoder_type="v2_deep_sets",
        ),
    ...
    # SS + Dropout combined: zero-out + 20% per-predicate dropout
    TrainConfig(
        name="pi_behavior_b1k_exp3_ss_dropout",
        exp_name="exp3_ss_dropout",
        project_name="B1K",
        model=pi_behavior_config.PiBehaviorConfig(
            action_horizon=30,
            action_dim=32,
    ...
    # ================================================================
    # Third round: FiLM + Soft Pooling (fix state signal drowning)
    # ================================================================
    # New exp3: Deep Sets + FiLM modulation + Fourier progress
    TrainConfig(
        name="pi_behavior_b1k_exp3_film",
        exp_name="exp3_film",
        project_name="B1K",
        model=pi_behavior_config.PiBehaviorConfig(
            action_horizon=30,
            ...
            use_knowledge_insulation=False,
            freeze_vision_backbone=True,
            predicate_encoder_type="v3_film",
            predicate_data_path="/vast/projects/kumar/lab/yishao/b1k_2/data/predicate_data_v2_smoothed",
            predicate_loss_weight=0.1,
            progress_loss_weight=0.05,
        ),
    ...
    # New exp2: V1 task-specific embeddings + soft pooling
    TrainConfig(
        name="pi_behavior_b1k_exp2_soft",
        exp_name="exp2_soft",
        project_name="B1K",
        model=pi_behavior_config.PiBehaviorConfig(
            action_horizon=30,
            ...
            use_knowledge_insulation=False,
            freeze_vision_backbone=True,
            predicate_encoder_type="v2_soft",
            predicate_data_path="/vast/projects/kumar/lab/yishao/b1k_2/data/predicate_data_v2_smoothed",
            predicate_loss_weight=0.1,
            progress_loss_weight=0.05,
        ),
