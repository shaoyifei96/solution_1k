...
#SBATCH --mem=250G
#SBATCH --output=/vast/projects/kumar/lab/yishao/jobs/logs/eval_exp1_6k-%A-%a.out
#SBATCH --error=/vast/projects/kumar/lab/yishao/jobs/logs/eval_exp1_6k-%A-%a.err
#SBATCH --array=0-19
...
LOG_PATH=${EVAL_LOG_DIR}/${TASK_NAME}_exp1_step6000_${SLURM_ARRAY_JOB_ID}
