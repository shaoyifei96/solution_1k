...
#SBATCH --mem=250G
#SBATCH --output=/vast/projects/kumar/lab/yishao/jobs/logs/eval_exp3_5k-%A-%a.out
#SBATCH --error=/vast/projects/kumar/lab/yishao/jobs/logs/eval_exp3_5k-%A-%a.err
#SBATCH --array=0-19
...
CHECKPOINT_DIR=$HOME_DIR/checkpoints_50/pi_behavior_b1k_exp3/exp3_v2_deep_sets/5000
EVAL_LOG_DIR=$HOME_DIR/eval_logs
LOG_PATH=${EVAL_LOG_DIR}/${TASK_NAME}_exp3_step5000_${SLURM_ARRAY_JOB_ID}
...
uv run scripts/serve_b1k.py \
    --port $PORT \
    policy:checkpoint \
    --policy.config pi_behavior_b1k_exp3 \
