...
#SBATCH --mem=250G
#SBATCH --output=/vast/projects/kumar/lab/yishao/jobs/logs/eval_exp2_6k-%A-%a.out
#SBATCH --error=/vast/projects/kumar/lab/yishao/jobs/logs/eval_exp2_6k-%A-%a.err
#SBATCH --array=0-19
...
LOG_PATH=${EVAL_LOG_DIR}/${TASK_NAME}_exp2_step6000_oracle_${SLURM_ARRAY_JOB_ID}
...
hostname
echo "=== Eval exp2 step 6000 (oracle): $TASK_NAME (4 instances) ==="
echo "Start: $(date)"
